...
export class Inventario implements OnInit {
  ...
  readonly tipusOptions: TipusFilter[] = ['Tots', 'Aigua', 'Terra', 'Aire'];
  readonly midaOptions:  MidaFilter[] = ['Tots', 'Petit', 'Mitjà',  'Gran'];
 
  readonly starsArray = Array.from({ length: 40 }, () => ({
  ...
  // ── Separar slots llenos de los vacíos ───────────────────────────────
